...
\fill[teal!70] (1.15,0.45) rectangle (1.80,0.76);
\fill[blue!45] (1.15,0.76) rectangle (1.80,3.15);
\fill[red!45] (1.15,3.15) rectangle (1.80,3.15);
\draw (1.15,0.45) rectangle (1.80,3.15);
\node[below] at (1.47,0.45) {0.00};
\fill[teal!70] (2.85,0.45) rectangle (3.50,0.77);
\fill[blue!45] (2.85,0.77) rectangle (3.50,3.06);
\fill[red!45] (2.85,3.06) rectangle (3.50,3.15);
\draw (2.85,0.45) rectangle (3.50,3.15);
\node[below] at (3.17,0.45) {0.05};
\fill[teal!70] (4.55,0.45) rectangle (5.20,0.78);
\fill[blue!45] (4.55,0.78) rectangle (5.20,3.06);
\fill[red!45] (4.55,3.06) rectangle (5.20,3.15);
\draw (4.55,0.45) rectangle (5.20,3.15);
\node[below] at (4.88,0.45) {0.10};
\fill[teal!70] (6.25,0.45) rectangle (6.90,0.83);
\fill[blue!45] (6.25,0.83) rectangle (6.90,3.05);
\fill[red!45] (6.25,3.05) rectangle (6.90,3.15);
