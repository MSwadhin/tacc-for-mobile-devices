...
Replication weight \(\lambda\) & 0.02 \\
Redundancy weight \(\beta\) & 18.0 \\
Relocation weight \(\mu\) & 0.04 \\
...
Online DQN consistently outperforms topology-aware greedy and fixed Greedy+DQN across the tested perturbation range. However, at \(p=0.25\), the Keep Current baseline is slightly better than Online DQN, indicating that high-perturbation windows may require a stricter no-update decision rule.
