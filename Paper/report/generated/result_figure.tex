...
\draw[gray, thick] (1.00,1.36) -- (3.00,1.42) -- (5.00,1.49) -- (7.00,1.52);
\fill[gray] (1.00,1.36) circle (1.6pt);
\fill[gray] (3.00,1.42) circle (1.6pt);
\fill[gray] (5.00,1.49) circle (1.6pt);
\fill[gray] (7.00,1.52) circle (1.6pt);
\draw[gray, thick] (7.9,0.80) -- (8.35,0.80);
\node[right] at (8.4,0.80) {Random};
\draw[blue, thick] (1.00,2.85) -- (3.00,2.81) -- (5.00,2.77) -- (7.00,2.79);
\fill[blue] (1.00,2.85) circle (1.6pt);
\fill[blue] (3.00,2.81) circle (1.6pt);
\fill[blue] (5.00,2.77) circle (1.6pt);
\fill[blue] (7.00,2.79) circle (1.6pt);
\draw[blue, thick] (7.9,1.25) -- (8.35,1.25);
\node[right] at (8.4,1.25) {Local Popularity};
\draw[orange, thick] (1.00,0.77) -- (3.00,0.88) -- (5.00,0.84) -- (7.00,1.14);
\fill[orange] (1.00,0.77) circle (1.6pt);
\fill[orange] (3.00,0.88) circle (1.6pt);
\fill[orange] (5.00,0.84) circle (1.6pt);
\fill[orange] (7.00,1.14) circle (1.6pt);
\draw[orange, thick] (7.9,1.70) -- (8.35,1.70);
\node[right] at (8.4,1.70) {Diversified Popularity};
\draw[teal, thick] (1.00,0.75) -- (3.00,0.96) -- (5.00,1.00) -- (7.00,1.13);
\fill[teal] (1.00,0.75) circle (1.6pt);
\fill[teal] (3.00,0.96) circle (1.6pt);
\fill[teal] (5.00,1.00) circle (1.6pt);
\fill[teal] (7.00,1.13) circle (1.6pt);
\draw[teal, thick] (7.9,2.15) -- (8.35,2.15);
\node[right] at (8.4,2.15) {Topology-Aware Greedy};
\draw[red, thick] (1.00,0.75) -- (3.00,0.88) -- (5.00,0.84) -- (7.00,1.10);
\fill[red] (1.00,0.75) circle (1.6pt);
\fill[red] (3.00,0.88) circle (1.6pt);
\fill[red] (5.00,0.84) circle (1.6pt);
\fill[red] (7.00,1.10) circle (1.6pt);
